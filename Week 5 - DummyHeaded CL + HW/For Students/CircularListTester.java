...
public class CircularListTester{
  ...
  public static void main(String [] args){
    ...
    printList(h2.head); //20,30,40,10
    
    System.out.println("\n/////  Test 03  /////");
    h2.buildReverse();
    printList(h2.head);//10,40,30,20
    
    System.out.println("\n/////  Test 04  /////");
    h2.addElement(60,2);
    printList(h2.head);//10,40,60,30,20
    h2.addElement(70,5);
    printList(h2.head);//10,40,60,30,20,70
    h2.addElement(70,-3);
    printList(h2.head);//10,40,60,30,20,70
    
    System.out.println("\n/////  Test 05  /////");
    h2.deleteElement(2);
    printList(h2.head);//10,40,30,20,70
    h2.deleteElement(4);
    printList(h2.head);//10,40,30,20
    h2.deleteElement(-3);
    printList(h2.head);//10,40,30,20
